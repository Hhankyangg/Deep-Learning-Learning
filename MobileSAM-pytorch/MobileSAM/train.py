...
def parse_option():
    ...
    # dataset paths
    parser.add_argument('--dataset_path', type=str, default="/aifs4su/mmcode/videogen/arctanx/dataset", help='root path of dataset')
    ...
    parser.add_argument('--root_path', type=str, default="/aifs4su/mmcode/videogen/arctanx/MobileSAM-pytorch/MobileSAM", help='root path')
